...
sw.predict = TRUE
sw.varswitch = "model_data/2023/Var-variable_switches-pub.csv"
...
#fdir <- 'output/1-2023-11-27-19:20:11-15706342b4af3f'
...
if (sw.processData){
  ...
  #A: 22,205,4
  soc_eco = readRDS("model_data/2023/A-socioEcoDat-array-pub.rds") 
  
  #C: 205,16082
  #first_sight = readRDS("model_data/regionalized_model_data/C-firstSightings-matrix.rds") 
  first_sight = readRDS("model_data/2023/C_new-firstSightings-matrix.rds")
  #D: 205,205,1
  pairwise_data = readRDS("model_data/2023/D-pairwiseData-array.rds")
